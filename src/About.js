      ...
      <div className="about">
        ...
        <div className="leftPanel">
          <div>
            ...
            <p>
              I graduated from University of California, San Diego with a
            ...
            <p>
              ...
              values are critical to my development as a software engineer.
            </p>
            <p>
              I began learning to code in middle school. My instructor invited
              me to join a Python coding club. This experience motivated me to
              enroll in{" "}
              <a href="https://codenation.org/" target="_blank">
                <b>CodeNation</b>
              </a>
              , a program that teaches numerous programming languages and
              professional skills, as well as pursue a degree in computer
              science in college.
            </p>
            <p>
              My main priority right now is to graduate from the University of
              California, San Diego while also honing my technical and
            ...
            <p>
              ...
              , and volunteer for various causes in my community.
            </p>

            <div className="contact">
              <a href="https://github.com/kennytrbl" target="_blank">
                <svg
                  height="24"
                  width="24"
                  viewBox="0 0 16 16"
              ...
              <a href="https://twitter.com/_kennyzhang" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
        ...
        <div className="rightPanel">
          <div>
            <img
              rel="preload"
              as="image"
              src={require("./gallery/1.webp")}
            ></img>
            <img
              rel="preload"
              as="image"
              src={require("./gallery/2.webp")}
            ></img>
          </div>
        </div>
      </div>
